...
//import Matkalista from './components/Matkalista';
 ...
 const mat = { otsikko: 'Koulussa', paiva: '14.1.2019', paikka: 'Helsinki', saa: 'Lumisadetta, -1', kuvaus: 'Koulussa' } 
...
class MatkaApp extends Component {
    render() {
        return (
            <div>
            {
                 <Matkalomake matka= { mat } /> //komponenttia kutsutaan, suoritetaan matka.js koodia
            }
